  ...
  return (
    <section className="flex flex-col items-center bg-[#E57A56] p-10 space-y-4">
      ...
      <div className="bg-[#F8D1B4] p-5 rounded-3xl text-center space-y-4">
        ...
        <a href="mailto:yourwebsolutions3000@gmail.com?subject=Consulta web Habitos" className="bg-white rounded-3xl text-sm sm:text-lg font-bold py-1 px-4 text-[#BC4E2A]">
          Hacer Consulta
        </a>
      </div>
    </section>
